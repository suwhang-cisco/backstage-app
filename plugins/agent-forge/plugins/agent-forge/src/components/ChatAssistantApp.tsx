...
// Button import removed as we're using a custom div
  ...
  async function handleMessageSubmit(msg?: string) {
    ...
    switch (continueMessaging(input)) {
      case UserResponse.RESET:
        ...
        await delay(500);
        addBotMessage({
          text: 'Cleaning up previous chat. Minimizing Agent Tim...',
          isUser: false,
          timestamp,
        });
        await delay(3000);
      ...
      case UserResponse.NEW:
        resetChatContext();
        addBotMessage({
          text: 'Hi, I am Agent Javis, your AI Platform Engineer. How can I help you today?',
    ...
    return (
      ...
      >
        <img
          ...
          alt="Click this Agent Tim Logo to open AgentForge"
        />
      </div>
    );
  }
